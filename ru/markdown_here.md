...
*Markdown Это* расширение для Google Chrome, Firefox, Safari, Opera и Thunderbird, которое позволяет писать электронные письма <sup>†</sup> в Markdown <sup>‡</sup> и отображать их перед отправкой. Он также поддерживает подсветку синтаксиса (просто укажите язык в изолированном блоке кода).
